[![Build Status](https://travis-ci.com/mtumilowicz/java11-default-methods-conflicts.svg?branch=master)](https://travis-ci.com/mtumilowicz/java11-default-methods-conflicts)
